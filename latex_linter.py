...
class linter_rules:
    ...
    def add_newline(self):
        ...
        if self.obj.get("newline", False):
            ...
            print("The newline option is not set correctly in the JSON file. Please read the README file.")
                ...
                for line_num, line in enumerate(self.lines_container):
                    ...
                    try:
                        if words[0].find("begin{") == True :
                            ...
                            #print(env_name)
                            while line_num < len(self.lines_container) - 1 and end_env not in self.lines_container[line_num+1]:
                                self.lines_container[line_num+1] = "\t" + self.lines_container[line_num+1]
                                line_num += 1
                    except IndexError:
                        continue
            else:
    ...
    def add_blank_lines(self):
        ...
        try:
            if self.obj.get("blank_lines", False):
                ...
                print("The value of 'blank_lines' in the JSON file is either False or missing. Please read README file.")
        except KeyError:
            print("The JSON file does not contain the key 'blank_lines'. Please read README file.")
    ...
    def format_comment(self):
        ...
        try:
            if self.obj.get("comment_space", True):
                ...
                print("The value of 'format_comment' in the JSON file is either False or missing. Please read README file.")
        except KeyError:
            print("The JSON file does not contain the key 'format_comment'. Please read README file.")

def _main_():
    parser = argparse.ArgumentParser(description='Name of the file')
    parser.add_argument('fileName', type=str, help='name of latex file you want to modify')
